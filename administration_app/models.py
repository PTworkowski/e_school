...
class Course(models.Model):
    ...
    zoom_link = models.URLField(max_length=500, default="", null=True, blank=True)
    level = models.CharField(max_length=225)
    teacher = models.ForeignKey(MyUser, on_delete=models.SET_NULL, default=None, null=True, blank=True,
                                related_name='teacher')
    student = models.ManyToManyField(MyUser, related_name='students', blank=True)
